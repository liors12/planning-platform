...
def main(argv: List[str] | None = None) -> int:
    ...
    print(f"  manifests returned: {len(document['manifests'])}")
    print(f"  aggregate token usage: {result.aggregate_usage}")
    print(f"  total key rotation attempts: {result.total_key_attempts}")
