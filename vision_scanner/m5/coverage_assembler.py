...
HIGHLIGHTED_GAPS_HE: List[Dict[str, str]] = [
    ...
    },
    {
        ...
        "detail": "ההגשה אינה כוללת טבלת שטחים מפורטת. כל 33 שורות הבדיקה בקטגוריות אלו מציגות 'לא הוגש' (11 תאי שטח × 3 שדות). יש לבקש מהאדריכל טבלת שטחים מפורטת בהגשה הבאה.",
        "task_ref": None,
    },
    {
    ...
    },
    {
        ...
        "detail": "ההגשה מציגה התפלגות לפי מספר חדרים, אך תקנון 5.table מצריך פילוח לפי שטח (≤55 מ\"ר / 56-75 / 76-99 / ≥100). בחלק מתאי השטח לא ניתן לפצל ללא שטח לכל יחידת דיור.",
        "task_ref": None,
    },
]
