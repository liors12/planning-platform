...
CATEGORY_INTROS_HE = {
    ...
    "FIX":     "פריטים שהוגשו אך דורשים שינוי. ממוינים לפי דחיפות.",
    "CLARIFY": "פריטים הדורשים הבהרה או אישור מצד האדריכל. ממוינים לפי דחיפות.",
}
...
ITEMS_CURATED: List[Dict[str, Any]] = [
    ...
    # ============== CLARIFY ==============
    {
        ...
        "one_line_he": "תא שטח 5 — שני מפלסים בתשריטים מציגים גובה מוחלט מעל תקרת §6.7 (91.00 מ׳ מעל פני הים): 91.30 מ׳ ו-91.80 מ׳. יש להבהיר האם אביזרי גג, קווי מעטפת, או חריגה אמיתית.",
    ...
    },
    {
        ...
        "one_line_he": "קווי בניין (כל תאי השטח) — לא ניתן לאמת אוטומטית ללא קובץ DWG מפורק. עד אז נדרשת השלמת אימות ידני של מהנדס/ת המינהלת מול התשריט.",
    ...
    },
    {
        ...
        "one_line_he": "צבע כותרות הפרקים הראשיים — נדרש אימות ויזואלי שכל הכותרות בצבע טורקיז אחיד, כנדרש בחוברת ההנחיות (§6.2).",
        "source_section": "נספח א (פורמט)",
        "anchor_target_id": "sec-appendix-a",
    },
    {
